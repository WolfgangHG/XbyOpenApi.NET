...
#pragma warning disable CS1591
  public partial class ChatGetConversationResponse_meta : IAdditionalDataHolder, IParsable
...
#nullable restore
    ...
    public string NextToken { get; set; }
#endif
    /// <summary>The number of message events returned.</summary>
    public int? ResultCount { get; set; }
    /// <summary>
    /// Instantiates a new <see cref="global::XbyOpenApi.Core.Client.Models.ChatGetConversationResponse_meta"/> and sets the default values.
    /// </summary>
    public ChatGetConversationResponse_meta()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="global::XbyOpenApi.Core.Client.Models.ChatGetConversationResponse_meta"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static global::XbyOpenApi.Core.Client.Models.ChatGetConversationResponse_meta CreateFromDiscriminatorValue(IParseNode parseNode)
    {
      if (ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
      return new global::XbyOpenApi.Core.Client.Models.ChatGetConversationResponse_meta();
    }
    /// <summary>
